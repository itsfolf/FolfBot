...
module.exports = {
    ...
    SlashCommand: {
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (!voiceChannel) return client.sendTime(interaction, "❌ | **You must be in a voice channel to use this command.**", true);
            ...
            let CheckNode = client.Manager.nodes.get(client.botconfig.Lavalink.id);
            if (!CheckNode || !CheckNode.connected) {
              return client.sendTime(interaction,"❌ | **Lavalink node not connected**", true);
            }
